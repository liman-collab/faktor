...
class PreconfiguredScenariosPro implements Hookable {
	...
	private function add_price_scenarios( array $scenarios ) {
		$url = $this->is_pl() ? 'https://www.wpdesk.pl/docs/procentowy-koszt-wysylki-woocommerce/' : 'https://docs.flexibleshipping.com/article/39-flexible-shipping-cost-as-a-percentage-of-orders-value';
	...
	private function prepare_combining_shipping_classes_scenario() {
		$url = $this->is_pl() ? 'https://www.wpdesk.pl/docs/laczenie-klas-wysylkowych-woocommerce/' : 'https://docs.flexibleshipping.com/article/37-flexible-shipping-combining-different-shipping-classes-in-the-cart';
	...
	private function prepare_disable_or_hide_shipping_method_scenario() {
		$url = $this->is_pl() ? 'https://www.wpdesk.pl/docs/wylaczanie-metody-wysylki-woocommerce/' : 'https://docs.flexibleshipping.com/article/45-flexible-shipping-disable-hide-shipping-method';
		$shipping_classes = $this->get_shipping_classes();
	...
	private function prepare_extra_cost_for_every_item_scenario() {
		$url = $this->is_pl() ? 'https://www.wpdesk.pl/docs/koszt-produkt-woocommerce/' : 'https://docs.flexibleshipping.com/article/42-flexible-shipping-extra-cost-for-every-item';
		return new PredefinedScenario(
			__( 'Price', 'flexible-shipping-pro' ),
	...
	private function prepare_progressive_weight_based_shipping_scenario() {
		$url = $this->is_pl() ? 'https://www.wpdesk.pl/docs/koszt-bazowy-i-koszt-dodatkowy-w-oparciu-o-wage-wysylka-woocommerce/' : 'https://docs.flexibleshipping.com/article/38-flexible-shipping-progressively-increasing-weight-based-shipping';
	...
	private function prepare_combining_cost_calculation_conditions_scenario() {
		$url = $this->is_pl() ? 'https://www.wpdesk.pl/docs/laczenie-warunkow-obliczania-kosztow-wysylki/' : 'https://docs.flexibleshipping.com/article/1087-flexible-shipping-combining-the-shipping-cost-calculation-conditions';
		$shipping_classes = $this->get_shipping_classes();
		$available = count( $shipping_classes ) >= 1;
		$rules = $available
