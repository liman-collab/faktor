 ...
 */
class PluginsPageRenderer implements \FSProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
    ...
    public function output_render(string $plugin_file)
    {
        ...
        $form_content = new \FSProVendor\WPDesk\License\ActivationForm\Renderer($this->plugin_info);
