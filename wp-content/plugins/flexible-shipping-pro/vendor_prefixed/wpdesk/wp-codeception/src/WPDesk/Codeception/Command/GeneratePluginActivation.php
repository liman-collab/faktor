 ...
 */
class GeneratePluginActivation extends \FSProVendor\Codeception\Command\GenerateTest implements \FSProVendor\Codeception\CustomCommandInterface
{
    /**
    ...
    {
        return new \FSProVendor\WPDesk\Codeception\Command\AcceptanceTestGenerator($config, $class);
    }
    /**
     * Execute command.
     *
