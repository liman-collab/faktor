...
trait LocalCodeceptionTrait
{
     ...
     * @param Configuration   $configuration
     */
    private function installPlugin($plugin_dir, \FSProVendor\Symfony\Component\Console\Output\OutputInterface $output, \FSProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
