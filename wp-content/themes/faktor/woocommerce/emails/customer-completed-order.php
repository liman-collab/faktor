...
<p><?php printf( ucfirst(esc_html__( 'Just to let you know — we\'ve received your order #%s, and it is now being processed:', 'woocommerce' )), esc_html( $order->get_order_number() ) ); ?></p>
