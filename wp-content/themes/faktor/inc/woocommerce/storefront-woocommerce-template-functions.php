	...
	function storefront_cart_link() {
		?>
			<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'storefront' ); ?>">
				...
				<?php echo wp_kses_post( WC()->cart->get_cart_subtotal() ); ?> <span class="count"><?php echo wp_kses_data( sprintf( _n( '%d Artikel', '%d Artikel', WC()->cart->get_cart_contents_count(), 'storefront' ), WC()->cart->get_cart_contents_count() ) ); ?></span>
			</a>
		<?php
	}
}
...
if ( ! function_exists( 'storefront_header_cart' ) ) {
	...
	function storefront_header_cart() {
		...
		<ul id="site-header-cart" class="site-header-cart menu">
            <li class="login-li">
                <a class="my-account-top" href="/wp-admin"><span class="dashicons dashicons-admin-users"></span> Anmeldung</a>
            </li>
			<li class="cart-li <?php echo esc_attr( $class ); ?>">
